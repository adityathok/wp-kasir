  ...
  <div class="container-fluid" style="--bs-nav-link-font-size: 0.9rem;">
    ...
    <div class="collapse navbar-collapse" id="navbarApp">
      <ul class="navbar-nav ms-auto my-2 my-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo get_permalink(); ?>/?pg=order">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo get_permalink(); ?>/?pg=member">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="<?php echo get_admin_url(); ?>">WP Admin</a></li>
          </ul>
        </li>
      </ul>    
